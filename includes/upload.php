...
class  Media {
  ...
  public $userPath = SITE_ROOT.DS.'..'.DS.'uploads'.DS.'users';
  public $productPath = SITE_ROOT.DS.'..'.DS.'uploads'.DS.'products';
  ...
  public function process_user($id){
    ...
    if(!file_exists($this->userPath)){
        if(!mkdir($this->userPath, 0777, true)){
            $this->errors[] = "Failed to create directory {$this->userPath}";
            return false;
        }
    }
